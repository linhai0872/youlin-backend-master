...
import com.linhai.youlin.constant.UserConstant;
...
import com.linhai.youlin.utils.AlgorithmUtils;
...
import static com.linhai.youlin.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "linhai";
     ...
     */
    @Override
    public User getSafetyUser(User originUser) {//返回除了密码等敏感信息
        if (originUser == null) {
            return null;
        }
    ...
    public List<User> matchUsers(long num, User loginUser) {
        QueryWrapper<User> queryWrapper = new QueryWrapper<>();
        queryWrapper.select("id", "tags");//重点 只查询id和tag列 省时间和空间
    ...
    public User getUserByPrincipalName(String principalName) {
        ...
        QueryWrapper<User> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq("userAccount", principalName); // 假设 principal name 是 userAccount
